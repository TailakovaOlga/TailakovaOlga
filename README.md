...
В 2024 году закончила курсы на платформе Netology по специальности тестировщик ПО. Получила знания и практический опыт в ручном тестировании веб-приложений(тест-кейсы, чек-листы, баг-репорты, Jira), тестирование Rest API (Postman), автоматизированном тестировании (Java, JUNIT,Selenide);.**
